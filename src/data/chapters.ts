export const chapters: Record<string, string[]> = {
  ...
  "7-English": [
    "Learning Together – The Day the River Spoke",
    "Learning Together – Try Again",
    "Learning Together – Three Days to See",
    "Wit and Humour – Animals, Birds and Dr. Dolittle",
    "Wit and Humour – A Funny Man",
    "Wit and Humour – Say the Right Thing",
    "Dreams and Discoveries – My Brother's Great Invention",
    ...
    "Travel and Adventure – Conquering the Summit",
    "Bravehearts – A Homage to Our Brave Soldiers",
    "Bravehearts – My Dear Soldiers",
    "Bravehearts – Rani Abbakka"
  ],
  "7-Hindi": [
    "माँ, कह एक कहानी",
    "तीन बुद्धिमान",
  ...
  "7-Social Science": [
    "Our Earth: A Tapestry of Life",
    "Interior of the Earth",
    "Our Changing Planet",
    "Air Around Us",
    "Water: A Precious Resource",
    "Life in the Natural Regions",
...
export function getChapters(classId: number, subject: string): string[] {
  const key = `${classId}-${subject}`;
  return chapters[key] || Array.from({ length: classId >= 11 ? 12 : 10 }, (_, i) => `Chapter ${i + 1} (Placeholder)`);
}

export function isPlaceholder(classId: number, subject: string): boolean {
  return !chapters[`${classId}-${subject}`];
}
